...
<script src="https://www.utopiadayspasalon.com/wp-content/themes/utopia-salon/js/jquery-1.8.3.min.js"></script>
<script>
				...
				<nav>
					<ul>
						<li data-dropdown="menu-1" data-options="is_hover:true" aria-expanded="false">
							<a><i class="icon nav-icon-scissors"></i> The Essentials</a>
						...
						<li data-dropdown="menu-2" data-options="is_hover:true" aria-expanded="false">
							<a><i class="icon nav-icon-rocks"></i> The Experience</a>
